...
function scanValue(type, value) {
    const typeOfNumber = ['number', 'range'];
    let newVal = null;
    if (value) {
...
export { setAttributes, createDomElement, addDomElement, getDefaultMessageError, isArray, isRequired, preprocessField, scanValue };

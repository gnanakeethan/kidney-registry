...
export type UserLoginMutation = {
	...
	userLogin: {
		...
		error?: { __typename?: 'Error'; status: number; string: string } | null;
	};
};

export type NewPatientMutationVariables = Exact<{ [key: string]: never }>;

export type NewPatientMutation = {
	__typename?: 'Mutation';
	newPatient?: {
		__typename?: 'Person';
		ID?: string | null;
		...
		Phn?: string | null;
		PrimaryRenalDisease?: string | null;
		Weight?: number | null;
		Height?: number | null;
		Gender?: Gender | null;
		MaritalStatus?: MaritalStatus | null;
		ContactNo?: string | null;
		PersonType?: PatientType | null;
...
export type MedicalHistoryFragment = {
	__typename?: 'PersonMedicalHistory';
	ID: string;
...
export type ListUsersQuery = {
	...
	users?: {
		__typename?: 'UserList';
		users: Array<{ __typename?: 'User'; name: string; id: string }>;
		pagination?: { __typename?: 'Pagination'; itemsPerPage: number; totalItems: number } | null;
	} | null;
};
...
export const MedicalHistoryFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
			name: { kind: 'Name', value: 'MedicalHistory' },
			typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'PersonMedicalHistory' } },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					...
					{ kind: 'Field', name: { kind: 'Name', value: 'Medications' } },
					{
						kind: 'Field',
...
} as unknown as DocumentNode<MedicalHistoryFragment, unknown>;
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					...
					{ kind: 'Field', name: { kind: 'Name', value: 'Phn' } },
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'PrimaryRenalDisease' }
					},
			...
			variableDefinitions: [
				{
					...
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'UserLogin' } }
					}
				}
			],
			selectionSet: {
						...
						arguments: [
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'userLogin' },
								value: { kind: 'Variable', name: { kind: 'Name', value: 'userLogin' } }
							}
						],
						selectionSet: {
							kind: 'SelectionSet',
	...
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'NewPatient' },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					{
...
} as unknown as DocumentNode<NewPatientMutation, NewPatientMutationVariables>;
	...
	definitions: [
		{
			...
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'patientInput' } },
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'PersonInput' } }
					}
				}
			],
			selectionSet: {
						...
						arguments: [
							{
								...
								value: { kind: 'Variable', name: { kind: 'Name', value: 'patientInput' } }
							}
						],
						selectionSet: {
							kind: 'SelectionSet',
...
} as unknown as DocumentNode<UpdatePatientMutation, UpdatePatientMutationVariables>;
export const NewHistoryDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'mutation',
			name: { kind: 'Name', value: 'NewHistory' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					...
					type: {
						kind: 'NonNullType',
						type: { kind: 'NamedType', name: { kind: 'Name', value: 'PersonMedicalHistoryInput' } }
					}
				}
			],
			selectionSet: {
				...
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'MedicalHistory' } }
							]
						}
					}
				]
		...
		...MedicalHistoryFragmentDoc.definitions
	]
} as unknown as DocumentNode<NewHistoryMutation, NewHistoryMutationVariables>;
			...
			variableDefinitions: [
				{
					...
					type: { kind: 'NamedType', name: { kind: 'Name', value: 'UserListFilter' } }
				},
				{
					kind: 'VariableDefinition',
...
export const ListPatientsDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'ListPatients' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
					variable: { kind: 'Variable', name: { kind: 'Name', value: 'filter' } },
		...
		...PersonFieldsFragmentDoc.definitions
	]
} as unknown as DocumentNode<ListPatientsQuery, ListPatientsQueryVariables>;
				...
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'PersonFields' } }
							]
						}
					}
				]
...
export type NewPatientMutationStore = OperationStore<
	NewPatientMutation,
	NewPatientMutationVariables
>;
export type UpdatePatientMutationStore = OperationStore<
	UpdatePatientMutation,
	UpdatePatientMutationVariables
>;
export type NewHistoryMutationStore = OperationStore<
	NewHistoryMutation,
	NewHistoryMutationVariables
>;

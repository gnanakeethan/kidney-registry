...
<script lang="ts">
	...
	let props = {
		...
		base: '/patients-recipient/view/' + $recipientId + '/investigations/',
		routes: [
			{
				name: 'New',
				route: '/patients-recipient/view/' + $recipientId + '/investigations/new',
				icon: UserIcon
			},
			{
				name: 'Previous Records',
				route: '/patients-recipient/view/' + $recipientId + '/investigations/',
				icon: UserIcon
			}
		]
	};

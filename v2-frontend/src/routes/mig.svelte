            ...
            <li key="{project.id}">
              <a href="#"
                ...
                <span class="flex items-center space-x-3 truncate">
                  <span class="{[project.bgColorClass, 'w-2.5 h-2.5 flex-shrink-0 rounded-full']}"
                        aria-hidden="true">
                  </span>
                ...
                <tr key="{project.id}">
                  ...
                  <td class="px-6 py-3 text-sm font-medium text-gray-500">
                    <div class="flex items-center space-x-2">
                      ...
                      {#if project.totalMembers > project.members.length}
...
<script setup>
  ...
  const navigation = [
    ...
    { name: 'My tasks', href: '#', icon: null, current: false },
    { name: 'Recent', href: '#', icon: null, current: false },
  ]
  const teams = [
